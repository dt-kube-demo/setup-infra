...
# derived values
export AZURE_RESOURCEGROUP="$AZURE_OWNER_NAME-dt-kube-demo-group"
export AZURE_CLUSTER="$AZURE_OWNER_NAME-dt-kube-cluster"
export AZURE_WORKSPACE="$AZURE_OWNER_NAME-dt-kube-workspace"
export AZURE_DEPLOYMENTNAME="$AZURE_OWNER_NAME-dt-kube-deployment"
export AZURE_SERVICE_PRINCIPAL="$AZURE_OWNER_NAME-dt-kube-sp"
